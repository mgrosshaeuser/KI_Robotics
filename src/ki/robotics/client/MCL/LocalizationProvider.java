...
public interface LocalizationProvider {
    ArrayList<MCLParticle> generateInitialParticleSet();
    ...
    double getEstimatedPoseDeviation();
    double getMedianParticleWeight();
    boolean isLocalizationDone();
    void badParticlesFinalKill();
    ArrayList<WorldState> getWorldStateSequence();
